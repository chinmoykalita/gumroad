...
RSpec.describe ComputedChurnAnalyticsDay do
  describe ".read_data_from_keys" do
    it "returns hash with sorted existing keys and parsed values" do
      create(:computed_churn_analytics_day, key: "k2", data: { v: 2 }.to_json)
      create(:computed_churn_analytics_day, key: "k0", data: { v: 0 }.to_json)
